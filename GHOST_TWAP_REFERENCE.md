...
in their existing evidence archive. The Historical win rate feature and its dedicated live database copies were
removed at the owner's request on September 23, 2026. The separate preserved
research archive remains unchanged.
...
when interpreting the historical results.

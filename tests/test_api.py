...
def test_openapi_lists_market_data_flags(client):
    ...
    for params in (current_data_params, market_data_params):
        assert "include_flow" in params
        assert "include_book" in params
        assert "include_microstructure" in params
        assert "microstructure_groups" in params
